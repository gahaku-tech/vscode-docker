...
suite("configure (Add Docker files to Workspace)", function (this: Suite): void {
    ...
    const dotNetCoreConsole_11_ProjectFileContents = `
      <Project Sdk="Microsoft.NET.Sdk">
...
`;
    ...
    suite(".NET Core Console", () => {
        ...
        async function testDotNetCoreConsole(os: OS, projectFileContents: string, expectedDockerFileContents: string): Promise<void> {
            testInEmptyFolder(os, async () => {
                await writeFile('projectFolder', 'aspnetapp.csproj', projectFileContents);
        ...
        testInEmptyFolder("Windows", async () => {
            ...
            suite(".NET Core 2.0", async () => {
                testDotNetCoreConsole("Windows", dotNetCoreConsole_20_ProjectFileContents,
...
`);
                ...
                // testDotNetCoreConsole("Linux", dotNetCoreConsole_20_ProjectFileContents);
